            ...
            if (doc.version == version)
            {
                ...
                return this.table()
                    ...
                    .then(function (result)
                    {
                        if (result.skipped == 1)
                        {
                            return this.rebase(doc, version, patch, user_id)
                        }
                        else
                        {
...
Table.prototype.rebase = function (doc, version, patch, user_id)
{
    return this.op_table()
        .between([doc.id, version], [doc.id, db.r.maxval], { index: 'docid_version' })
        .run()
        .then(function (ops)
        {
            var patches = ops
            ...
            var new_patch = jiff_rebase(patches, patch)
            return this.patch(doc.id, doc.version, new_patch, user_id)
        }.bind(this))
}


Table.prototype.delete = function (id, user_id)
{
    return this.table()
        .get(id)
